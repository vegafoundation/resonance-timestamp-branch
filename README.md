...
This repository contains the conceptual definition and theoretical framework for **Timestamp-Branch**, 
...
├── LICENSE             # CC BY 4.0
├── paper/
│   └── timestamp-branch.tex    # LaTeX dissertation
├── whitepaper/
│   └── timestamp-branch.md     # White paper
└── translations/
    ├── de/             # German
    ├── en/             # English
    ├── tr/             # Turkish
...
```bibtex
@misc{vega2025timestampbranch,
  author = {Vega, Adam Eren},
  title = {Timestamp-Branch: A Conceptual Framework},
  year = {2025},
  publisher = {GitHub},
  url = {https://github.com/vegafoundation/timestamp-branch}
}
```
